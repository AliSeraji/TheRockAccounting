...
export default function PageHeader({
  ...
  return (
    <header className="h-auto bg-white/50 backdrop-blur-md border border-white/60 fixed top-20 left-4 right-4 z-40 rounded-2xl shadow-lg shadow-slate-200/50">
